...
function App() {
	...
	const handleDone = (index$1) => {
		const updatedTask = task.map((t, i) => i === index$1 ? {
			...t,
			isDone: !t.isDone
		} : t);
		setTask(updatedTask);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "flex bg-red-300 gap-8 w-[700px] h-[100px] justify-center items-center mt-8 border-4 rounded-lg text-xl font-bold text-red-800 border-black",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { children: [
					"Total No of Todos :",
					total,
					" "
				] }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { children: ["Completed Todos : ", done] })]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
					...
					className: "border-2 text-lg p-4 w-[500px] rounded-lg"
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					className: "bg-green-400 p-4 border-2 border-green-700 rounded-lg text-lg font-bold",
					onClick: handleAdd,
					children: "Add"
				})]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: task.map((t, index$1) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex gap-8",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
						type: "text",
						placeholder: "task 1 ",
						value: t.text,
						className: `border-2 text-lg p-4 w-[500px] rounded-lg ${t.isDone ? "line-through" : ""}`
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						className: "bg-amber-500 p-4 border-2 border-amber-900 text-base font-bold rounded-lg",
						onClick: () => handleDone(index$1),
						children: "Done"
					})]
				}, index$1))
			})
